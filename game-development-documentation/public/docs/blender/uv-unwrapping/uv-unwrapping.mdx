...
## Moving Mesh After Adding Texture
1. If you try and just move an edge the texture will stretching
![](./assets/move-causes-distortion.gif)

2. Use **G** then **G** again to initiate **Edge Slide**
![](./assets/edge-slide.gif)

3. You can then press **C** which clamps and allows you to move farther out than the original mesh
![](./assets/edge-slide-clamp.gif)

## Unwrapping to Match Textures with Words

1. First go into **Side View**
![](./assets/side-view.png)

2. Press **U** for the **Unwrap Menu** then select **Project from View**
![](./assets/project-from-side-view.png)

3. The mesh will scale as you are seeing it, in the **UV Editor**
![](./assets/unwrapped-item-from-perspective.png)

4. Now the texture will appear normal and not stretched
![](./assets/texture-not-stretched.png)